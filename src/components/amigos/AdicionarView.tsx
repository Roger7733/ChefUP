          ...
          {resultados.map((item) => {
            ...
            return (
              <View key={item.id} style={styles.card}>
                ...
                {estado === 'enviado' && (
                  <View style={styles.botaoNeutro}><Text style={styles.botaoNeutroTexto}>Pendente</Text></View>
                )}
                {estado === 'recebido' && (
                  <View style={styles.botaoNeutro}><Text style={styles.botaoNeutroTexto}>Te adicionou</Text></View>
                )}
                {estado === 'amigo' && (
                  <View style={styles.botaoNeutro}><Text style={styles.botaoNeutroTexto}>✓ Amigo</Text></View>
                )}
              </View>
            );
          })}
...
const styles = StyleSheet.create({
  ...
  botaoSeguir: { backgroundColor: '#D63E2A', paddingVertical: 8, paddingHorizontal: 16, borderRadius: 8 },
  botaoAceitar: { backgroundColor: '#4F7239', paddingVertical: 8, paddingHorizontal: 16, borderRadius: 8 },
  botaoTexto: { color: '#FFF', fontWeight: 'bold' },
  botaoNeutro: { backgroundColor: '#F4ECD8', paddingVertical: 8, paddingHorizontal: 16, borderRadius: 8 },
